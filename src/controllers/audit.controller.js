...
// Permanently delete a single wholesaler's uploaded file for an audit:
// removes its child rows, the file record, and the physical CSV from disk.
// Scoped strictly by wholesaler_name so other suppliers stay untouched.
